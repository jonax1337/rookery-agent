...
// MotionProps shadows these DOM props with incompatible handler types
// (onAnimationStart/onDrag* get motion signatures, children accepts
// MotionValue). Existing consumers spread plain DOM button props into
// Button (calendar, tooltip-icon-button), so the DOM variants win here.
type ButtonDOMProps = Pick<
...
function Button({
  ...
  asChild = false,
  ...props
}: Omit<HTMLMotionProps<"button">, keyof ButtonDOMProps> &
  ButtonDOMProps &
