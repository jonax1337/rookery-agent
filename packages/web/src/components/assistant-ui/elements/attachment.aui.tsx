...
const AttachmentPreviewDialog: FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="aui-attachment-preview-dialog-content [&>button]:bg-foreground/60 [&>button]:hover:bg-foreground/80 [&_svg]:text-background p-2 sm:max-w-3xl [&>button]:rounded-md [&>button]:p-1 [&>button]:opacity-100 [&>button]:ring-0!">
...
const AttachmentRemove: FC = () => {
  return (
    <AttachmentPrimitive.Remove asChild>
      <TooltipIconButton
        tooltip="Remove file"
        className="aui-attachment-tile-remove absolute end-1 top-1 size-5 rounded-md bg-black/50! text-white after:absolute after:-inset-1.5 hover:bg-black/70! hover:text-white! motion-reduce:transition-none"
        side="top"
      >
  ...
  return (
    <ComposerPrimitive.AddAttachment asChild>
      <TooltipIconButton
        ...
        variant="ghost"
        size="icon"
        className="aui-composer-add-attachment text-muted-foreground hover:text-foreground hover:bg-muted-foreground/15 dark:border-muted-foreground/15 dark:hover:bg-muted-foreground/30 size-7 rounded-md motion-reduce:transition-none"
